...
\bibitem{b1} F. Serpush, M. B. Menhaj, B. Masoumi, and B. Karasfi, 
...
\bibitem{b2} Health Service Executive (HSE), ``Seniors Alert Scheme,'' \textit{Health Service Executive}, 2024. [Online]. Available: https://www.hse.ie/eng/services/list/4/olderpeople/carersrelatives/community-support-for-older-people-.html. [Accessed: Oct. 19, 2025].

\bibitem{b3} M. Kangas, R. Korpelainen, I. Vikman, L. Nyberg, and T. Jämsä, 
...
\bibitem{b4} E. Malone, ``Staff shortages and public perception leading to healthcare worker burnout, Fórsa research suggests,'' 
...
\bibitem{b5} A. Logacjov, K. Bach, A. Kongsvold, H. B. Bårdstu, and P. J. Mork, 
...
\bibitem{b6} K. Bach, A. Logacjov, A. Kongsvold, H. B. Bårdstu, and P. J. Mork, 
...
\bibitem{b7} Adafruit Industries, ``Adafruit Feather nRF52840 Sense - Overview,'' [Online]. Available: https://learn.adafruit.com/adafruit-feather-sense/overview. [Accessed: Oct. 19, 2025].

\bibitem{b8} Maker Advisor, ``ESP32 Development Boards Review and Comparison,'' 
